...
const UserList = ({ users, onSelectUser }) => (
  <div className="space-y-4">
    <div className='bg-amber-300  top-0  py-1 md:py-2 text-white rounded-b-md poppins-semibold text-lg md:text-xl text-center'>Users List</div>
    ...
    {users.length === 0 ? (
      ...
      users.map((user, index) => (
        ...
        >
          <img src={user.avatar} alt={user.name} className="w-10 md:w-28 h-10 md:h-28 rounded-full mr-1 md:mr-4" />
